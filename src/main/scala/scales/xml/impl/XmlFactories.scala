    ...
    factory.loan {
      f =>
        ...
        if (!Versions.newSchemaShouldSerialize)
          f.newSchema(source)
        else if (source.isInstanceOf[ScalesSource]) {
...
/**
  ...
  */
object DefaultSAXParserFactoryPool extends SimpleUnboundedPool[SAXParserFactory] {
  pool =>
...
/**
  ...
  */
object NoVersionSAXParserFactoryPool extends SimpleUnboundedPool[SAXParserFactory] {
  pool =>
...
/**
  ...
  */
object DefaultXMLReaderFactoryPool extends SimpleUnboundedPool[XMLReader] with DefaultSaxSupport {
  pool =>
...
/**
  ...
  */
object DefaultDOMFactoryPool extends SimpleUnboundedPool[DocumentBuilderFactory] {
  pool =>
...
/**
  ...
  */
object DefaultStaxInputFactoryPool extends SimpleUnboundedPool[XMLInputFactory] {
  pool =>
...
/**
  ...
  */
object DefaultXSDSchemaFactoryPool extends SimpleUnboundedPool[SchemaFactory] {
  pool =>
