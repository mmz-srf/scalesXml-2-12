...
/**
 * A Zero in type Z provides the identity element for the operation  { @link scalaz6.Semigroup # append }
 * in the corresponding  { @link scalaz6.Semigroup } in type Z.
 * <p/>
